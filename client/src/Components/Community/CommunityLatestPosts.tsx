...
interface CommunityLatestPostsProps {
  communityId: string;
}

const CommunityLatestPosts: React.FC<CommunityLatestPostsProps> = ({
  communityId,
}) => {
  ...
  const { doFetch } = useFetch<{
    ...
    url: `${base_url}/community/${communityId}/post/latest?page=${currentPage}`,
    method: 'GET',
    authorized: true,
    onSuccess: (data) => {
